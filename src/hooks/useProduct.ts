...
import { fetchCategories, fetchProducts, setCategory, setPage } from '@/store/slices/product.slice';
...
export function useProduct() {
    ...
    const { list, categories, loading, pagination, queryParams } = useSelector((state: RootState) => state.product);
    ...
    // Action 封裝
    const handleSetCategory = (categoryId: string) => dispatch(setCategory(categoryId));
