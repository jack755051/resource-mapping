...
const MOCK_DB: Record<string, ProductDetailData> = {
    ...
    'gc-ip50-w288': {
        ...
        tags: ['AI', 'IP68'],
        specs: [
            { label: '畫素', value: '5MP', type: 'sensor' },
            { label: '變焦', value: '電動', type: 'lens' },
            { label: '防水', value: 'IP68', type: 'waterproof' },
            { label: '材質', value: 'SUS316L', type: 'protection' },
        ],
        description:
            '專為極端環境設計的水下攝影機，採用 SUS316L 醫療級不鏽鋼打造，具備 IP68 最高防水等級。內建 AI 影像增強算法，能在混濁水域中自動調節對比度與色彩，提供清晰的監控畫面。適用於深海養殖、水利工程及船舶監控。',
        features: [
...
const MOCK_RELATED: ProductCardData[] = [
    {
        ...
        tags: ['AI'],
        specs: [
            { label: '辨識率', value: '99%', type: 'sensor' },
            { label: '快門', value: '全域', type: 'lens' },
        ],
    },
    {
        id: '3',
        ...
        tags: ['PTZ'],
        specs: [
            { label: '倍率', value: '30x', type: 'lens' },
            { label: '夜視', value: '200M', type: 'power' },
        ],
    },
    {
        id: '4',
        ...
        tags: ['4K'],
        specs: [
            { label: '頻道', value: '64CH', type: 'sensor' },
            { label: '硬碟', value: '8 Bay', type: 'lens' },
        ],
    },
];
