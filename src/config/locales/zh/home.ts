export const zhHome = {
  ...
  'home.capabilities.subtitle': '我們不只賣監視器...',
  'home.capabilities.visual.title': '視覺化管理系統',
  'home.capabilities.visual.desc': '將「我不知道」轉變為...',
  'home.capabilities.extreme.title': '超越極限',
  'home.capabilities.extreme.desc': 'IP68 防水與高速球機...',
  'home.capabilities.install.title': '專業施工',
  'home.capabilities.install.desc': '拒絕雜亂線路...',
  'home.capabilities.home.tag': '居家方案',
  'home.capabilities.home.title': '企業級的居家防護',
  'home.capabilities.home.desc': '用工廠級的技術...',
