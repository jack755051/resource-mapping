...
export const dictionaries: Record<LanguageCode, Dictionary> = {
  zh: {
    ...
    'home.hero.subtitle': '安全不該只是被動紀錄，而是主動防禦。從產線細節到園區死角，我們用工業級視野，將風險阻絕於發生之前。',
    ...
    'home.clients.factory.desc': '監控生產流程、預防意外，並透過 24/7 耐用設備保全庫存。',
    'home.clients.retail.title': '零售與商業空間',
    'home.clients.retail.desc': '發生糾紛即時釐清，並透過單一裝置管理多個分店。',
    'home.clients.special.title': '特殊場域工程',
    'home.clients.special.desc': '水下攝影、高速球型攝影機，針對嚴苛環境的高速捕捉方案。',
    ...
    'home.capabilities.visual.desc': '將「我不知道」轉變為「讓我們確認」。這套系統讓您能管理人員效率並即時解決糾紛。這不只是安防，更是您的營運槓桿。',

    // Extreme Tech (Special)
    'home.capabilities.extreme.title': '超越極限',
    'home.capabilities.extreme.desc': 'IP68 防水與高速球機。我們能看見別人看不見的細節。',

    // Installation (Pain Point)
    'home.capabilities.install.title': '專業施工',
    'home.capabilities.install.desc': '拒絕雜亂線路。我們引以為傲的是美觀、工業級的佈線品質。',

    // Home (Family)
    'home.capabilities.home.tag': '居家方案',
    'home.capabilities.home.title': '企業級的居家防護',
    'home.capabilities.home.desc': '用工廠級的技術保護您的家人。穩定、安全，時刻連接您最珍視的一切。',
  ...
  en: {
    ...
    'home.hero.subtitle': 'Security requires active defense, not just passive recording. From production details to perimeter blind spots, we use industrial-grade vision to preempt risks before they occur.', 'home.hero.cta.business': 'Consult for Business',
    ...
    'home.clients.factory.desc': 'Monitor production flow, prevent accidents, and secure inventory with 24/7 durability.',
    'home.clients.retail.title': 'Retail & Commercial',
    'home.clients.retail.desc': 'Resolve disputes instantly and manage multiple store locations from a single device.',
    'home.clients.special.title': 'Specialized Fields',
    'home.clients.special.desc': 'Underwater cams, Speed Domes, and High-Speed capture for challenging environments.',

    // =================================================================
    // Home Page: Section C - Capabilities
    // =================================================================
    'home.capabilities.title': 'Why Choose Us?',
    'home.capabilities.subtitle': 'We don\'t just sell cameras. We provide a complete visual strategy.',

    // Visual Management
    'home.capabilities.visual.title': 'Visual Management System',
    'home.capabilities.visual.desc': 'Turn "I don\'t know" into "Let\'s verify." Our system gives you the power to manage personnel efficiency and resolve disputes instantly. It\'s not just security; it\'s your operational leverage.',

    // Extreme Tech
    'home.capabilities.extreme.title': 'Beyond Limits',
    'home.capabilities.extreme.desc': 'Waterproof (IP68) & High-Speed Domes. We see what others can\'t.',

    // Installation
    'home.capabilities.install.title': 'Pro Installation',
    'home.capabilities.install.desc': 'No messy wires. We pride ourselves on aesthetic, industrial-grade cabling.',

    // Home
    'home.capabilities.home.tag': 'Residential',
    'home.capabilities.home.title': 'Enterprise Grade for Home',
    'home.capabilities.home.desc': 'Protect your family with the same technology used by factories. Stable, secure, and always connected to what matters most.',

    // =================================================================
    // Home Page: Section D - CTA
    // =================================================================
    'home.cta.title': 'Don\'t let "Unknown" be a cost.',
    'home.cta.subtitle': 'Get a professional site assessment for your facility or specialized project today.',
