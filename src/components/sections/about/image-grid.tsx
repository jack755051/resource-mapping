    ...
    <section className="w-full border-y border-border/40 bg-muted/20">
      <div className="section-container section-y">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6 h-auto md:h-[600px]">
          {/* 左側大圖 */}
          <div className="md:col-span-8 relative rounded-4xl overflow-hidden group min-h-[400px]">
            <Image
            ...
            {/* 底部資訊面板 */}
            <div className="absolute bottom-0 left-0 w-full p-5 sm:p-6 md:p-8 border-t border-white/10 bg-black/40 backdrop-blur-md">
          ...
          <div className="md:col-span-4 flex flex-col gap-6">
            {/* 右上：特殊場域 */}
            <div className="flex-1 relative rounded-4xl overflow-hidden group min-h-[250px]">
              <Image
              ...
              <div className="absolute bottom-0 left-0 w-full p-6 border-t border-white/10 bg-black/40 backdrop-blur-md">
                <div className="flex flex-col items-start gap-2">
                  <span className="px-2 py-0.5 rounded text-[10px] font-bold bg-accent-blue text-white tracking-wider shadow-sm">
            ...
            <div className="flex-1 relative rounded-4xl overflow-hidden group min-h-[250px]">
              ...
              <div className="absolute bottom-0 left-0 w-full p-6 border-t border-white/10 bg-black/40 backdrop-blur-md">
                <div className="flex flex-col items-start gap-2">
                  <span className="px-2 py-0.5 rounded text-[10px] font-bold bg-accent-orange text-white tracking-wider shadow-sm">
