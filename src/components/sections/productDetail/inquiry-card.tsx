...
export function ProductInquiryCard({ className, classNames, props }: ProductInquiryCardProps) {
    ...
    return (
        ...
        >
            ...
            <p className={cn("text-sm text-muted-foreground mb-4 leading-relaxed", classNames?.description)}>
