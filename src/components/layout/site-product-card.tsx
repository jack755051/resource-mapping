...
export function ProductCard({ data, className, classNames }: ProductCardProps) {
    const { title, category, image, specs, tags, href } = data;
    ...
    return (
        ...
        >
            ...
            <CardContent className="p-6 py-4 flex-1">
                <div className={cn("grid grid-cols-2 gap-y-3 gap-x-4", classNames?.specsGrid)}>
            ...
            <CardFooter className={cn("p-6 pt-2 border-t border-border/30 bg-muted/5 mt-auto", classNames?.footer)}>
